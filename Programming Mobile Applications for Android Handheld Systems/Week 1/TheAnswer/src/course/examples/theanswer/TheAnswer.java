...
public class TheAnswer extends Activity {
	...
	public static final String PROG_NAME = "The Answer";
	...
	private int findAnswer() {
		Log.i(PROG_NAME, "findAnswer...");
		
		for (int val : answers) {
			Log.i(PROG_NAME, "val: " + val);
			if (val == answer)
				Log.i(PROG_NAME, "found a match!");
				return val;
		}
		Log.i(PROG_NAME, "did not find a match");
		return -1;
	}
}
